...
const Home = () => {
  return (
    <div
      id="home"
      className="w-12/12 mx-auto flex flex-col justify-center items-center text-center min-h-[100vh] gap-10 min-w-[320px] bg-gradient-to-r from-bglight via-gray-700 to-bg"
    >
      ...
      <div className="text-6xl md:text-8xl lg:text-[150px] font-bold flex items-center gap-2 p-[200px] rounded-3xl">
