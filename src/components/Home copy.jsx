...
const Home = () => {
  return (
    <div
      id="home"
      className="w-10/12 mx-auto flex flex-col justify-center items-center text-center min-h-[60vh] lg:min-h-[100vh] gap-10 min-w-[500px] bg-bg"
    >
      ...
      <div className="bg-bglight p-6 border-l-4 border-r-4 border-secondary relative">
        <h2 className="text-6xl lg:text-8xl font-bold md:p-3">
          Front-Ent Developer
        </h2>
      ...
      <div className="text-4xl lg:text-7xl font-bold flex items-center gap-2 p-5 border-secondary rounded-3xl border-2">
